...
/* harmony default export */ var todos = (function () {
  ...
  switch (type) {
    case actions["a" /* ADD_TODO */]:
      return [].concat(_toConsumableArray(state), [{
        id: Math.random().toString(36).substring(2),
        text: text
      }]);

    case actions["b" /* REMOVE_TODO */]:
...
var createStoreWithMiddleware = Object(external_redux_["applyMiddleware"])()(external_redux_["createStore"]);
/* harmony default export */ var utils_store = (function (initialState) {
  return createStoreWithMiddleware(reducers, initialState, enhancers);
});
...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(app_["Container"], null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Todo App")), external_react_default.a.createElement(external_react_redux_["Provider"], {
        store: store
